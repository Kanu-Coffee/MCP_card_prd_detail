...
class WorkerSettings:
    ...
    def from_env(cls, *, require_providers: bool = False, require_webdav: bool = False) -> WorkerSettings:
        ...
        return cls(
            ...
            ocr_model=os.environ.get("CARDRAG_OCR_MODEL", "gpt-5.4"),
            ...
            ocr_prompt_version=os.environ.get("CARDRAG_OCR_PROMPT_VERSION", "cardrag-ocr.ko.v1"),
            ...
            ocr_chunk_pages=_positive_int("CARDRAG_OCR_CHUNK_PAGES", 2),
