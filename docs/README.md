...
현재 보호해야 할 운영 기준은 v1.0.9이며 v1.0.11은 별도 candidate에서만
...
2. [장애 분석](V1_0_11_INCIDENT.md)
3. [candidate migration과 rollback](V1_0_11_MIGRATION.md)
4. [archive와 운영 state 관리](V1_0_11_ARCHIVE_MANAGEMENT.md)
5. [v1.0.10 구조·임베딩·exact 검색 baseline](V1_0_10_STRUCTURE_EMBEDDING.md)
6. [v1.0.10 acceptance baseline](V1_0_10_ACCEPTANCE.md)
7. [v1.0.10 candidate acceptance receipt baseline](V1_0_10_CANDIDATE_ACCEPTANCE.md)
8. [Chainguard/Wolfi 컨테이너 런타임 baseline](V1_0_10_CONTAINER_RUNTIME.md)
...
서비스합니다. v1.0.11 candidate acceptance는 stable 전환이나 구버전 cleanup을
자동 승인하지 않습니다.
