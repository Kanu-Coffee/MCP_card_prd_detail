...
class CandidateImageIdentity(_CanonicalModel):
    ...
    version: Literal["1.0.22", "1.0.23", "1.0.24", "1.0.25", "1.0.26", "1.0.27", "1.0.28"]
...
class EffectiveConfigEvidence(_CanonicalModel):
    ...
    release_version: Literal["1.0.22", "1.0.23", "1.0.24", "1.0.25", "1.0.26", "1.0.27", "1.0.28"]
...
def verify_candidate_acceptance(
    ...
    *,
    ...
    expected_generation_schema, expected_serving_schema = (
        ...
        if receipt.release_version in ("1.0.26", "1.0.27", "1.0.28")
