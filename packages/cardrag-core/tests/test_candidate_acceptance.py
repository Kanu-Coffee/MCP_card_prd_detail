...
def _write_valid_bundle(root: Path) -> AcceptanceBundle:
    ...
    config = EffectiveConfigEvidence(
        ...
        compose_project="cardrag-v113-candidate",
        channel="candidate-v1.0.11",
        worker_volume="cardrag-worker-v113-candidate-state",
        worker_state_mount_path="/var/lib/cardrag-worker",
        worker_codex_home_volume="cardrag-worker-v113-candidate-codex-home",
        ...
        mcp_volume="cardrag-mcp-v113-candidate-state",
        mcp_host="127.0.0.1",
        mcp_port=18013,
...
@pytest.mark.parametrize(
    ("field", "value"),
    (
        ("worker_codex_home_volume", "cardrag-worker-v113-candidate-state"),
