...
output=${1:-$repository_root/deploy/portainer/cardrag-stack.yaml}
...
if ! command -v docker >/dev/null 2>&1; then
    echo "Docker Compose is required to render the Portainer Stack" >&2
    exit 69
fi
...
echo "rendered Portainer Stack: $output"
